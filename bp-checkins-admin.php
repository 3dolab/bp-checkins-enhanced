...
function bp_checkins_admin_tabs( $active_tab = '' ) {
	...
	$tabs = apply_filters('bp_checkins_admin_tabs', $tabs, $admin_page);
...
function bp_checkins_settings_admin(){
	...
	$active = apply_filters('bp_checkins_admin_tabs', $active, $_GET['tab']);
	...
	<div class="wrap">
		...
		<form action="" method="post" id="bp-admin-form">
			...
			<?php else: ?>
				...
				<?php do_action('bp_checkins_admin_screen_tab', $_GET['tab'], $admin_page); ?>
